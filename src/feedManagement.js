...
const EmptyList = {
  view: (vnode) => {
    let chunk = `
      ...
      <ul>
        <li><a target="_blank" href="docs/index.html#/quickstart">Check out the Getting Started guide.</a></li>
        <li><a target="_blank" href="docs/index.html#/feeddiscovery">Learn more about feed discovery.</a></li>
        <li><a target="_blank" href="docs/index.html#/opml">Learn how to import an OPML from another reader.</a></li>
      </ul>
      `;
...
const Menu = {
  view: (vnode) => {
    return m("nav", [
      ...
      m("ul", [
        m("li", m(m.route.Link, { href: "/import-opml" }, "Import OPML")),
        m("li", m("a", { href: "#", onclick: exportOPML }, "Export OPML")),
        m(
          "li",
          m(m.route.Link, { href: "/opml-matcher" }, "Match Subscriptions"),
        ),
        m(
          "li",
          m(
